...
function Cart() {
  const disabledHours = () => {
    ...
    //Slice 
    return [...[...Array(24).keys()].slice(0,currentHour),...[...Array(24).keys()].slice(17,24)]; // Disable hours after the current hour
  };
  ...
  const disabledMinutes = () => {
    ...
    return (
      <div className="cartbiv">
        ...
        <TimePicker use12Hours format="h:mm a" onChange={onChange} order={true}  disabledHours={disabledHours}
      disabledMinutes={disabledMinutes}  presetsMaxWidth={10}/>
        <input type="text" className="input-delv" maxLength={4} placeholder="Delivery Room"/>
        <div className="cart_footer">
          <button type="button" id="order_btn" className="btn-send btn btn-primary text-center p-3 ">
            <SendIcon/> Send Order
          </button>
        </div>
      </div>
