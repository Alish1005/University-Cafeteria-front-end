...
function Dashboard() {
    ...
    return ( 
          <div className="sheetPrint">
              ...
              <button className='btn btn-primary CSVbtn'><GetAppIcon></GetAppIcon> CSV</button>
              <button onClick={()=>window.print()} className='btn btn-primary  PDFbtn ms-2'><GetAppIcon></GetAppIcon> PDF</button>
              ...
              <div className="chart row col-12" style={{height:"400px"}}>
                ...
                <div className="col-lg-6 col-md-12 mx-lg-0 mx-xs-0 mt-5" style={{height:"390px"}}>
                        <h5>Staff activities</h5>
                        <BarCharts data={staff} xkey="name" datakey="orders" datakey2="rating"/>
                    </div>
                    <div className="col-lg-6 col-md-12 mx-lg-0 mx-xs-0 mt-5" >
                        <h5>Rush Hours</h5>
                    <LineCharts data={RushHour} xkey="time"  datakey="total_orders" datakey2="this_year_orders"/>
                    </div>
                    <div className="col-lg-12 col-md-12 mx-lg-2 mx-xs-0" style={{height:"450px"}}>
