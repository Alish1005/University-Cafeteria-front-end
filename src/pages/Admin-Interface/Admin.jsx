          ...
          <div className="containers">
            ...
            <div className="contentContainer">
              <Routes>
                ...
                <Route
                  path="/itemManagment"
                  element={<ItemManagments setEditItemId={setEditItemId} />}
                />
                ...
                <Route
                  path="/StaffMenu"
                  element={
                    <StaffMenu CName={CustomerName} CPhone={CustomerPhone} />
                  }
                />
                ...
                <Route
                  path="/itemManagment/EditItem"
                  element={<EditItems id={EditItemId} />}
                />
